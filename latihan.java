            ...
            if (!gameOver()) {
                ...
                if (!hori[baris2 - 1][kolom2 - 1].equals(" ~ ")) {
                    ...
                    if (hori[baris1 - 1][kolom1 - 1].equals(hori[baris2 - 1][kolom2 - 1])) {
                        ...
                        System.out.println("Poin anda sekarang = "+poin1);
                    } else {
                        printhori();
            ...
            if (!gameOver()) {
                ...
                if (!hori[baris2 - 1][kolom2 - 1].equals(" ~ ")) {
                    ...
                    if (hori[baris1 - 1][kolom1 - 1].equals(hori[baris2 - 1][kolom2 - 1])) {
                        ...
                        printhori();
                        System.out.println("Jawaban anda Benar");
                        System.out.println("Poin anda sekarang = "+poin2);
                    } else {
                        printhori();
                        System.out.println("jawaban anda Salah");
                        hori[baris1 - 1][kolom1 - 1] = " ~ ";
                ...
                {
                    System.out.println(" ");
                    System.out.println("Pemain 1 adalah pemenang dengan poin : "+poin1);
                    System.out.println("Poin Pemain 2 : "+poin2);
                }
                else if(poin2 > poin1)
                {
                    System.out.println(" ");
                    System.out.println("Pemain 2 adalah pemenang dengan poin : "+poin2);
